...
/**
 * Port of 1.12.2 skeleton WalkAnimationBit: biped walk plus strafing leg overlay.
 */
public class Animation_Walk extends Animation {
   ...
   public void animate(EntityLivingBase argEntity, ModelBase argModel, EntityData argData) {
      ...
      ((ModelRendererBends)model.bipedRightArm).rotation.setSmoothY(0.0F, 0.8F);
      ((ModelRendererBends)model.bipedLeftArm).rotation.setSmoothY(0.0F, 0.8F);
      ...
      if (data.isStrafing()) {
         ((ModelRendererBends)model.bipedRightLeg).rotation.setSmoothZ(-5.0F + MathHelper.cos(limbSwing) * legSwingAmount, 1.0F);
         ((ModelRendererBends)model.bipedLeftLeg).rotation.setSmoothZ(-5.0F + MathHelper.cos(limbSwing + PI) * legSwingAmount, 1.0F);
      }

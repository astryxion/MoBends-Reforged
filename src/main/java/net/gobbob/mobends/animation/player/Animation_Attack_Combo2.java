...
/** 1.12.2 AttackSlashInwardAnimationBit. Combo hit 3. */
public class Animation_Attack_Combo2 {
   public static void animate(EntityPlayer player, ModelBendsPlayer model, Data_Player data) {
      ...
      Animation_Attack_Sword.setMainArm(model, 90.0F, 60.0F - armSwing * 180.0F, 0.9F);
      Animation_Attack_Sword.setOffArm(model, -20.0F, 0.3F);
      Animation_Attack_Sword.setForeArms(model, -10.0F, -60.0F, 0.3F);
      ...
      model.renderItemRotation.setX(50.0F);
   }
}

...
public class ModelBendsZombie extends ModelBiped {
   ...
   public void render(Entity argEntity, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_) {
      ...
      if (this.isChild) {
         float f6 = 2.0F;
         ModelRendererBends var10000 = (ModelRendererBends)this.bipedHead;
         var10000.scaleX *= 1.5F;
         var10000 = (ModelRendererBends)this.bipedHead;
         var10000.scaleY *= 1.5F;
         var10000 = (ModelRendererBends)this.bipedHead;
         var10000.scaleZ *= 1.5F;
         GL11.glPushMatrix();

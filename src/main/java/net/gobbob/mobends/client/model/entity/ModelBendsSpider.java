      ...
      if (Minecraft.getMinecraft().theWorld != null) {
         if (!Minecraft.getMinecraft().theWorld.isRemote || !Minecraft.getMinecraft().isGamePaused()) {
            ...
            if (Data_Spider.get(argEntity.getEntityId()).canBeUpdated()) {
               ...
               float f12 = -(MathHelper.cos(p_78087_1_ * 0.6662F * 2.0F + ((float)Math.PI * 1.5F)) * 0.4F) * p_78087_2_;
               ...
               float f16 = Math.abs(MathHelper.sin(p_78087_1_ * 0.6662F + ((float)Math.PI * 1.5F)) * 0.4F) * p_78087_2_;

...
//        Minecraft.getInstance().getTextureManager().bind(GuiSettingsWindow.BACKGROUND_TEXTURE);
//
//        // Container
//        Draw.borderBox(x + 4, y + 4, 100, getHeight(), 4, 36, 126);

        mc.font.drawShadow(new com.mojang.blaze3d.matrix.MatrixStack(), bender.getLocalizedName(), this.x + 38, this.y + 10, 0xffffff);

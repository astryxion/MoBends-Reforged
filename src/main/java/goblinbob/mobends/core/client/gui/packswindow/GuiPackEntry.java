...
public class GuiPackEntry implements IGuiListElement, IGuiDraggable
{
    ...
    public void draw(float partialTicks)
    {
        ...
        textureManager.bind(GuiPacksWindow.BACKGROUND_TEXTURE);
        ...
        textureManager.bind(thumbnailLocation);
        RenderSystem.color4f(1, 1, 1, 1);
        Draw.texturedRectangle(viewX + 2, viewY + 2, 25, 25, 0, 0, 25F / 32F, 25F / 32F);

        fontRenderer.drawShadow(new com.mojang.blaze3d.matrix.MatrixStack(), fontRenderer.plainSubstrByWidth(this.displayName, 70), viewX + 32, viewY + 1, 0xffffff);

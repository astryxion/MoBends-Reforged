...
public class GuiSectionButton
{
    ...
    public void display()
    {
        ...
        if (this.hover)
            RenderSystem.color4f(this.bgColor.r, this.bgColor.g, this.bgColor.b, this.bgColor.a);
        else
            RenderSystem.color4f(this.neutralColor.r, this.neutralColor.g, this.neutralColor.b, this.neutralColor.a);
        ...
        if (this.hover)
        {
            ...
            if (leftIcon != null)
            {
                ...
                RenderSystem.translatef(x + iconSpacing, y + height / 2F, 0);
            ...
            {
                RenderSystem.pushMatrix();
                RenderSystem.translatef(x + width - iconSpacing, y + height / 2F, 0);
                RenderSystem.scalef(scale, scale, 1);

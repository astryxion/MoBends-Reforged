...
public class GuiLocalPacks extends AbstractGui implements ISubscriber, IDisposable
{
    ...
    {
        boolean handled = availablePacksList.handleMouseScroll(delta);
        handled |= appliedPacksList.handleMouseScroll(delta);
        return handled;
    }
    ...
    public void draw(float partialTicks)
    {
        ...
        drawCenteredString(poseStack, fontRenderer, I18n.get("mobends.gui.unusedpacks"), x + GuiPacksWindow.EDITOR_WIDTH / 4, y + 8, 0xffffff);
        drawCenteredString(poseStack, fontRenderer, I18n.get("mobends.gui.appliedpacks"), x + GuiPacksWindow.EDITOR_WIDTH * 3 / 4 + 6, y + 8, 0xffffff);

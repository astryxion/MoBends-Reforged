...
public class PunchingAction extends AnimationBit<BipedEntityData<?>>
{
    ...
    protected final PunchAnimationBit bitPunchLeft = new PunchAnimationBit(HandSide.LEFT);
    protected final PunchAnimationBit bitPunchRight = new PunchAnimationBit(HandSide.RIGHT);

    protected HandSide punchingFist = HandSide.LEFT;
    protected float lastTicksAfterAttack = 0;

    public PunchingAction(HandSide ignoredHandSide)
    {
    ...
    public void perform(BipedEntityData<?> entityData)
    {
        ...
        {
            punchingFist = punchingFist == HandSide.LEFT ? HandSide.RIGHT : HandSide.LEFT;
        }
        ...
        {
            this.layerBase.playOrContinueBit(punchingFist == HandSide.LEFT ? bitPunchLeft : bitPunchRight, entityData);
        }

...
public class ToolAction extends AnimationBit<BipedEntityData<?>>
{
    ...
    public ToolAction(HandSide actionHand)
    {
    ...
    public void perform(BipedEntityData<?> data)
    {
        ...
        final HandSide activeHand = goblinbob.mobends.standard.animation.bit.biped.AttackArms
                .attackingArm(data, entity);

        boolean mainHandSwitch = activeHand == HandSide.RIGHT;
        float sideMultiplier = activeHand == HandSide.RIGHT ? 1.0F : -1.0F;

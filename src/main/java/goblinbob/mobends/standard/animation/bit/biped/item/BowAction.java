...
public class BowAction extends AnimationBit<BipedEntityData<?>>
{
	...
	public BowAction(HandSide handSide)
	{
	...
	public void perform(BipedEntityData<?> data)
	{
		...
		boolean mainHandSwitch = this.actionHand == HandSide.RIGHT;
		...
		if (data.isClimbing())
		{
			...
			float renderRotationY = MathHelper.wrapDegrees(living.yRot - headYaw - climbingRotation);

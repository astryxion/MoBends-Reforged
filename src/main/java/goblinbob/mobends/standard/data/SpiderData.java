...
public class SpiderData extends LivingEntityData<SpiderEntity>
{
    ...
    public SpiderData(SpiderEntity entity)
    {
        super(entity);
    }
    ...
    public void updateClient()
    {
        ...
        crawlProgress += MathHelper.sqrt((float) (this.motionX * this.motionX + this.motionY * this.motionY + this.motionZ * this.motionZ));
        wallFacing = calcWallFacing();
    }

    private static float angleTo(float yaw, Direction direction)
    {
        return Math.abs(MathHelper.wrapDegrees(yaw - direction.toYRot()));
    }

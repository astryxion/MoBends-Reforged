...
public class MatrixUtils
{
	...
	public static void inverse(IMat4x4d src, IMat4x4d dest)
	{
		...
		Vec4d Vector3d = new Vec4d(f[1*4 + 3], f[0*4 + 3], f[0*4 + 3], f[0*4 + 3]);

		Vec4d Inv0 = new Vec4d(
			Vec1.x * Fac0.x - Vec2.x * Fac1.x + Vector3d.x * Fac2.x,
			Vec1.y * Fac0.y - Vec2.y * Fac1.y + Vector3d.y * Fac2.y,
			Vec1.z * Fac0.z - Vec2.z * Fac1.z + Vector3d.z * Fac2.z,
			Vec1.w * Fac0.w - Vec2.w * Fac1.w + Vector3d.w * Fac2.w
		);
		Vec4d Inv1 = new Vec4d(
			Vec0.x * Fac0.x - Vec2.x * Fac3.x + Vector3d.x * Fac4.x,
			Vec0.y * Fac0.y - Vec2.y * Fac3.y + Vector3d.y * Fac4.y,
			Vec0.z * Fac0.z - Vec2.z * Fac3.z + Vector3d.z * Fac4.z,
			Vec0.w * Fac0.w - Vec2.w * Fac3.w + Vector3d.w * Fac4.w
		);
		Vec4d Inv2 = new Vec4d(
			Vec0.x * Fac1.x - Vec1.x * Fac3.x + Vector3d.x * Fac5.x,
			Vec0.y * Fac1.y - Vec1.y * Fac3.y + Vector3d.y * Fac5.y,
			Vec0.z * Fac1.z - Vec1.z * Fac3.z + Vector3d.z * Fac5.z,
			Vec0.w * Fac1.w - Vec1.w * Fac3.w + Vector3d.w * Fac5.w
		);
